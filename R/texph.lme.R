#' Post-hoc LaTeX tables for lme models
#' 
#' texph method for models of class \code{lme}.
#'
...
#' )
texph.lme <- function(mod, variable, pairwise = TRUE, estimate = TRUE, 
                      se = FALSE, df = TRUE, teststatistic = FALSE,
                      pval = TRUE, ci = TRUE, ci_level = 0.95, 
                      title = NULL, varlab = NULL, rowlabs = NULL, 
                      digits = 3, ...) {
  dotlist <- list(...)
