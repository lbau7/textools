#' Post-hoc LaTeX tables for lmerModLmerTest models
#' 
#' texph method for models of class \code{lmerModLmerTest}.
#'
...
#' )
texph.lmerModLmerTest <- function(mod, variable, pairwise = TRUE,
                                  estimate = TRUE, se = FALSE, df = TRUE,
