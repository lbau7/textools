ph.latex.lmerModLmerTest <- function(mod, variable, pairwise = TRUE, estimate = TRUE, 
  se = FALSE, df = TRUE, teststatistic = FALSE, pval = TRUE, 
  ci = TRUE, ci.level = 0.95, title = NULL, varlab = NULL, 
